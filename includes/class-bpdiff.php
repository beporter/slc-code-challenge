...
class Bpdiff {
	 ...
	 * the plugin.
	 *
	 * @var      Bpdiff_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		// prefix = `bpdiff` or `Bpdiff`
		$this->plugin_name = 'bp-diffbot-products';
		$this->version = '0.0.1';
	 ...
	 *
	 * - Bpdiff_Loader. Orchestrates the hooks of the plugin.
	 * - Bpdiff_i18n. Defines internationalization functionality.
	 * - Bpdiff_Admin. Defines all hooks for the admin area.
	 * - Bpdiff_Public. Defines all hooks for the public side of the site.
	 *
